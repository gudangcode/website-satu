<div class="card card-outline-primary">
        	...
        	<div class="row">
        		<div class="col-sm-12">
        			<div class="form-group">
		                <label for="nf-key">Pencarian Data</label>
                        ...
                        <span class="help-block">Pilih kolom pencarian</span>
		            </div>
        		</div>
        	</div>
        	<div class="row">
        		<div class="col-sm-12">
        			<div class="form-group">
		                <label for="nf-value">Kata Kunci Pencarian</label>
		                <input type="text" name="val_search" id="val_search" class="form-control" value=<?=@$val_search?> >
                        <span class="help-block">Masukkan Kata Kunci</span>
		            </div>
        		</div>
        	</div>
    ...
    <div class="card-footer">
        ...
        <button type="reset" class="btn btn-sm btn-success" onclick="set_action('getadd');"><i class="fa fa-plus"></i> Tambah Baru</button>
    </div>
</div>
