...
<div class="card">
    <div class="card-header">
        <strong>DATA BERITA ADVERTORIAL</strong>
    </div>
    <div class="card-block">
          ...
          <div class="row">
			...
			<div class="row">
        		<div class="col-sm-12">
        			<div class="form-group">
		                <label for="nf-value">Harga </label>
		                <input type="text" name="news_price" id="news_price" class="form-control" value=<?=@$val_search?> >
		            </div>
        		</div>
        	</div>
          ...
          <div class="row">
			...
			<div class="row">
        		<div class="col-sm-12">
        			<div class="form-group">
		                <label for="nf-value">Harga</label>
		                <input type="text" name="news_price" id="news_price" class="form-control" value="<?=$arr['news_price']?>" >
		            </div>
        		</div>
        	</div>
...
jQuery(function($) {
	...
	$('#news_price').mask('000.000.000.000.000', {reverse: true});
